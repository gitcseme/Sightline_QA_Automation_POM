...
public class ModifySearchInAdvancedSearch_Regression{
	...
	@Test(description ="RPMXCON-57975,RPMXCON-57968,RPMXCON-57958",dataProvider = "WPSearchwithOperators",groups = { "regression" },enabled=true)
	...
	@Test(description ="RPMXCON-57977,RPMXCON-57970,RPMXCON-57960",dataProvider = "WPSearchwithOperators",groups = { "regression" }, enabled=true)
	 ...
	 */
	@Test(description ="RPMXCON-57973,RPMXCON-57966,RPMXCON-57956",dataProvider = "WPSearchwithOperators",groups = { "regression" },enabled=true)
...
//		}
	...
	@Test(description ="RPMXCON-57976,RPMXCON-57969,RPMXCON-57959",dataProvider = "WPSearchwithOperators",groups = {"regression"},enabled=true )
	...
	@Test(description ="RPMXCON-57974,RPMXCON-57967,RPMXCON-57957",dataProvider = "WPSearchwithOperators",groups = { "regression" },enabled=true)
...
//		}
	...
	@Test(description ="RPMXCON-57971,RPMXCON-57964,RPMXCON-57951",dataProvider = "WPSearchwithOperators",groups = { "regression" },enabled=true)
	...
	@Test(description ="RPMXCON-57972,RPMXCON-57965,RPMXCON-57955",dataProvider = "WPSearchwithOperators",groups = { "regression" },enabled=true)
