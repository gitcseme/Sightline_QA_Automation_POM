...
public class BatchPrintRegression extends RegressionBase {
	...
	@Test(groups = {"BatchPrint", "Positive"})
	public void test_Given_login_to_new_batch_print_and_select_source_selection_When_select_production_set_Then_verify_production_set_displayed() throws Throwable
	{
		HashMap dataMap = new HashMap();

		ExtentTest test = report.startTest("Given login_to_new_batch_print and select_source_selection When select_production_set Then verify_production_set_displayed");
		...
		try {
			context.login_to_new_batch_print(true, dataMap);
			context.select_source_selection(true, dataMap);
			context.select_production_set(true, dataMap);
			dataMap.put("A", "");
			dataMap.put("TestCase", "4385");
			context.verify_production_set_displayed(true, dataMap);
		} catch (ImplementationException e) {
			test.log(LogStatus.SKIP, e.getMessage());
			Assert.assertTrue(e.getMessage(), false);;
		} catch (Exception e) {
	...
	public void test_Given_login_to_new_batch_print_and_select_source_selection_500PlusFolder_and_select_basis_for_printing_and_select_analysis_and_select_exception_file_types_meda_filesskiptrue_and_select_slip_sheets_truefalse_and_select_branding_redactions_and_select_export_format_When_click_download_file_link_Then_verify_exception_file_types_placeholders_printed() throws Throwable
	{
		...
		ExtentTest test = report.startTest("Given login_to_new_batch_print and select_source_selection_{500PlusFolder} and select_basis_for_printing and select_analysis and select_exception_file_types_{meda_files}{skip}{true} and select_slip_sheets_{true}{false} and select_branding_redactions and select_export_format When click_download_file_link Then verify_exception_file_types_placeholders_printed");
		...
		try {
			...
			dataMap.put("domain", "Not a Domain");
			context.login_to_new_batch_print(true, dataMap);
			dataMap.put("select_folder", "500 Plus Folder");
			context.select_source_selection_(true, dataMap);
			dataMap.put("basis_for_production", "Native");
			context.select_basis_for_printing(true, dataMap);
			context.select_analysis(true, dataMap);
			dataMap.put("excel_files_enabled", "true");
			...
			context.click_download_file_link(true, dataMap);
			dataMap.put("A", "");
			dataMap.put("TestCase", "9708|9709");
			context.verify_exception_file_types_placeholders_printed(true, dataMap);
		} catch (ImplementationException e) {
			test.log(LogStatus.SKIP, e.getMessage());
			Assert.assertTrue(e.getMessage(), false);;
		} catch (Exception e) {
	...
	public void test_Given_login_to_new_batch_print_and_select_source_selection_500PlusFiles_and_select_basis_for_printing_and_select_analysis_and_select_exception_file_types_meda_filesskiptrue_and_select_slip_sheets_truefalse_and_select_branding_redactions_and_select_export_format_When_click_download_file_link_Then_verify_exception_file_types_placeholders_printed() throws Throwable
	{
		...
		ExtentTest test = report.startTest("Given login_to_new_batch_print and select_source_selection_{500PlusFiles} and select_basis_for_printing and select_analysis and select_exception_file_types_{meda_files}{skip}{true} and select_slip_sheets_{true}{false} and select_branding_redactions and select_export_format When click_download_file_link Then verify_exception_file_types_placeholders_printed");
		...
		try {
			...
			dataMap.put("domain", "Not a Domain");
			context.login_to_new_batch_print(true, dataMap);
			dataMap.put("select_tag", "500 Plus Files");
			context.select_source_selection_(true, dataMap);
			dataMap.put("basis_for_production", "Native");
			context.select_basis_for_printing(true, dataMap);
			context.select_analysis(true, dataMap);
	...
	@Test(groups = {"BatchPrint", "Positive"})
	public void test_Given_login_to_new_batch_print_and_select_basis_for_printing_and_select_analysis_and_select_exception_file_types_meda_filesprintfalse_and_select_slip_sheets_email_values_and_select_branding_redactions_and_select_export_format_When_click_download_file_link_Then_verify_email_values_displayed() throws Throwable
	{
		HashMap dataMap = new HashMap();

		ExtentTest test = report.startTest("Given login_to_new_batch_print and select_basis_for_printing and select_analysis and select_exception_file_types_{meda_files}{print}{false} and select_slip_sheets_email_values and select_branding_redactions and select_export_format When click_download_file_link Then verify_email_values_displayed");
		...
		try {
			...
			context.select_basis_for_printing(true, dataMap);
			context.select_analysis(true, dataMap);
			dataMap.put("excel_files_enabled", "false");
			dataMap.put("other_exception_file_types", "false");
			dataMap.put("excel_files", "print");
			dataMap.put("media_files", "false");
			context.select_exception_file_types_(true, dataMap);
			dataMap.put("enable_slip_sheets", "true");
			dataMap.put("use_prior_production", "false");
			context.select_slip_sheets_email_values(true, dataMap);
			dataMap.put("branding_location", "center");
			dataMap.put("include_applied_redactions", "false");
			dataMap.put("opaque_transparent", "opaque");
			context.select_branding_redactions(true, dataMap);
			...
			context.click_download_file_link(true, dataMap);
			dataMap.put("A", "");
			dataMap.put("TestCase", "10585");
			context.verify_email_values_displayed(true, dataMap);
		} catch (ImplementationException e) {
			test.log(LogStatus.SKIP, e.getMessage());
			Assert.assertTrue(e.getMessage(), false);;
		} catch (Exception e) {
	...
	@Test(groups = {"BatchPrint", "Positive"})
	public void test_Given_login_to_new_batch_print_and_select_source_selection_500PlusFiles_and_select_basis_for_printing_and_select_analysis_and_select_exception_file_types_meda_filesprintfalse_and_select_slip_sheets_email_values_and_select_branding_redactions_and_select_export_format_When_click_download_file_link_Then_verify_email_values_displayed() throws Throwable
	{
		HashMap dataMap = new HashMap();
