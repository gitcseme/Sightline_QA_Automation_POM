...
public class CommunicationEXp_21 {
	...
	public void verify() throws InterruptedException {
		...
		baseClass.stepInfo("Verify the Communication map shows expected document count when source is  more than 1 'Folders'. ");
		// Login as RMU user
		...
		// select folder in WP to get expected doc count to be displayed communication explorer
		...
		baseClass.stepInfo("Search result is displayed[query:"+folderName+" AND "+folderName2+" ]and purehit is : " + purehit);
