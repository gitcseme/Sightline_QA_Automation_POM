...
// Added by krishna - new projects 
	...
	public static String pa6FullName;
...
//	public static String rev5FullName;
	public static String rev6FullName;
...
//	Added by Baskar - 29/11/2021
	...
	public void loadEnvConfig() throws ParseException, InterruptedException, IOException {
		...
		pa6FullName= envConfig.getPa6FullName();
		...
		rev6FullName= envConfig.getRev6FullName();
		...
		if (mode) {
			...
			pa6FullName= System.getProperty("pa6FullName");
