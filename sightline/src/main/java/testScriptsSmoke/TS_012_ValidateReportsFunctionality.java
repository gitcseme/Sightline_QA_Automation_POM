...
public class TS_012_ValidateReportsFunctionality {
	...
	public void customDDRExportAfterSwap() throws InterruptedException, ParseException, IOException {
		...
		cddr.swapMetaDataFields(0,5); Thread.sleep(1000);
		cddr.swapMetaDataFields(1,5); Thread.sleep(1000);
		cddr.swapMetaDataFields(2,5); Thread.sleep(1000);
		
		//Expected order in report
		ArrayList<String> expected = new ArrayList<String>();
		expected.add("EmailAllDomains");expected.add("FamilyID");expected.add("AllCustodians");
		expected.add("CreateDate");	expected.add("DocDate");expected.add("SourceDocID");
