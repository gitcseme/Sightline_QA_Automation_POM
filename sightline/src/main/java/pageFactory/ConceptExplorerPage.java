...
public class ConceptExplorerPage {
    ...
    public Element getReports_ConceptExplorer(){ return driver.FindElementByXPath("//*[@id='collapseOne']//a[contains(.,'Concept Explorer Report')]"); }
    ...
    public Element getApplyBtn(){ return driver.FindElementById("btnAppyFilter"); } 
  ...
  //  public ElementCollection getfindAllNodes(){ return driver.FindElementsByCssSelector("div[id='wrapper-graph']  g  text[class='nodetext']"); }
    ...
    public Element gettextpanel(){ return driver.FindElementByXPath(".//*[@id='textpannel']//span[starts-with(.,'1st Level')]"); }
    ...
    public void ValidateConceptExplorerreport() throws InterruptedException {
      	...
      	driver.WaitUntil((new Callable<Boolean>() {public Boolean call(){return 
      			getReports_ConceptExplorer().Visible()  ;}}), Input.wait30); 
		...
		driver.WaitUntil((new Callable<Boolean>() {public Boolean call(){return 
				getTally_SecurityGroupsButton().Enabled()  ;}}), Input.wait30); 
		getTally_SecurityGroupsButton().waitAndClick(5);
		//Thread.sleep(2000);
		
		driver.WaitUntil((new Callable<Boolean>() {public Boolean call(){return 
				getTally_SelectSecurityGroup().Enabled()  ;}}), Input.wait30); 
	...
	*/	  
		  driver.WaitUntil((new Callable<Boolean>() {public Boolean call(){return 
				  gettextpanel().Visible()  ;}}), Input.wait30);		
