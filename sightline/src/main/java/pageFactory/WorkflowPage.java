...
public class WorkflowPage {
	...
	public Element getWorkFlow_SelectWorkStatus(String WFName) {
		return driver.FindElementByXPath(".//*[@id='dt_basic']/tbody//td[contains(.,'" + WFName + "'')]//td[3]");
	}
	...
	public void newWorkFlowCreation(String wfName, String wfDesc, int savedSearch, boolean familyFlag, String folder,
			boolean folderFlag, String assgn, boolean assgnFlag) throws ParseException {
		createNewWorkFlow();
