...
public class DocumentAuditReportPage {
    ...
    //Added By jeevitha
    public Element getDASearchNode(String searchNode) { return driver.FindElementByXPath("//a[text()='"+searchNode+"']//i");} 
    public Element getwaitDialogue() { return driver.FindElementByXPath("//span[text()='Wait for Task to Complete?']");} 
    public Element getwaitOkBtn() { return driver.FindElementByXPath("//button[@id='btnYes']");} 
    public Element getDocAuditTable() { return driver.FindElementByXPath("//table[@id='dtDocumentAuditData']");} 
  
    public Element getDocIDTextBox() { return driver.FindElementByXPath("//input[@id='txtDocID']");} 
    ...
    public void verifySource(String source,String source1) throws InterruptedException {
		...
		driver.WaitUntil((new Callable<Boolean>() {
			public Boolean call() {
				return getDASearchNode(source).Visible();
			}
		}), Input.wait30);
