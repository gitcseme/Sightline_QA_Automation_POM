...
//		AssignmentsPage.navigateBack(2);
	...
	/**
	 * Author : Gopinath Created date: NA Modified date: NA Modified by: NA Testcase
	 * Testcase id : 53747 - To verify, As an RMU user login, I am able to assign individual document to Assignment from Doc List Page.
	 * Description : Verify assign single document in Doclist
	 * 
	 * @throws AWTException
	 */
...
//		AssignmentsPage.navigateToAssignmentsPage();
	 ...
	 public void verificationOfEmailAllDomainInDocListPage() throws InterruptedException, AWTException {
		...
		baseClass.stepInfo("Select Author name  From Filter and Applying Filter And Verifying The Name in Email All Domain");
	 ...
	 public void verificationOfEmailAuthorNameInDocListPage() throws InterruptedException, AWTException {
		...
		baseClass.stepInfo("Select Email Author Name  From Filter and Applying Filter And Verifying The Name in Email Author Name");
	 ...
	 /**
		 ...
		 * Testcase id : 53783 - To verify, as the user is able to remove all documents from Folder in Doc list page.
	 ...
	 public void verifyRemoveMultipleDocumentsFromFolderDocList() throws InterruptedException, AWTException {
		...
		baseClass.stepInfo("#### To verify, as the user is able to remove all documents from Folder in Doc list page ####");	
	 ...
	 /**
		 * Author : Gopinath Created date: NA Modified date: NA Modified by: Gopinath
		 * Testcase id : 53728-To verify user can unfold single document from Folder in Doc list page.
	 ...
	 /**
		 * Author : Gopinath Created date: NA Modified date: NA Modified by: Gopinath
		 * Testcase id : 53665- To verify user is be able to filter doc list grid by 'File Size'.
		 * Description : Verify user is be able to filter doc list grid by 'File Size'
		 * @throws AWTException 
		 */		 
	 ...
	 /**
		...
		public void verifyAdminReleaseSingleDocToSecurityGroup() throws InterruptedException {
			...
			baseClass.stepInfo("#### Verify PA release a single document to some security group from DocList page from Saved search. ####");
		 ...
		 /**
			...
			public void verifyAdminUnReleaseSingleDocToSecurityGroup() throws InterruptedException {
				...
				baseClass.stepInfo("#### Verify PA unrelease a single document to some security group from DocList page from Saved search. ####");
			 ...
			 /**
			 * Author : Gopinath Created date: NA Modified date: NA Modified by: Gopinath
			 * Testcase id : 53666- To validate user is able to shuffle the column position on doclist Grid.
			 * Description : Validate user is able to shuffle the column position on doclist Grid
			 * @throws AWTException 
			 */		 
		 ...
		 /**
			 * Author : Gopinath Created date: 09/10/2021 Modified date: NA Modified by: Gopinath
			 * Testcase id : 53663- To verify user will be able to hide a column on the doc list.
			 * Description : Verify user will be able to hide a column on the doc list
			 * @throws AWTException 
			 */		 
...
/**
             * Author : Gopinath Created date: NA Modified date: NA Modified by: Gopinath
             * Testcase id : 54241-To verify that if the user checks 'Select All' check box on the grid, a confirmation message will show up with OK/Cancel options.
             * Description : To verify that if the user checks 'Select All' check box on the grid, a confirmation message will show up with OK/Cancel options.
             * @throws AWTException
             */        
        ...
        @Test(description ="RPMXCON-54241",groups={"regression"})
         public void verifyUnreleaseSingleDocFromSecurityGroupOnDocList() throws InterruptedException, AWTException {
             baseClass=new BaseClass(driver);
                ...
                baseClass.stepInfo("#### verify that if the user checks 'Select All' check box on the grid, a confirmation message will show up with OK/Cancel options ####");   
         ...
         /**
  		 ...
  		 * Testcase id : 54529-Validate Doclist sorting after shuffling the columns in the list
