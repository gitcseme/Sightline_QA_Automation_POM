...
public class AssignmentReviewProgressReport_Regression {
	Driver driver;
	LoginPage lp;
	 ...
	 * @description: To Verify User will be able to export data in an excel format
	 *               from Review Progress by Assignment Report
	 */
	...
	public void verifyExportDataARPR() throws InterruptedException, ParseException {
		...
		bc.stepInfo(
				"To Verify User will be able to export data in an excel format from Review Progress by Assignment Report");
		...
		UserLoginActivityReport userLoginActivityRptPg = new UserLoginActivityReport(driver);
	 ...
	 * @throws InterruptedException
	 * @description: To Verify User will be able to export data in an excel format
	 *               from Review Progress by Reviewer Report
	 */
	...
	public void verifyExportDataRRPR() throws InterruptedException, ParseException {
		...
		bc.stepInfo(
				"To Verify User will be able to export data in an excel format from Review Progress by Reviewer Report");
		ReportsPage report = new ReportsPage(driver);
		SoftAssert sa = new SoftAssert();
		// Login as Reviewer Manager
		lp.loginToSightLine(Input.rmu1userName, Input.rmu1password);
	 ...
	 * @author Iyappan.Kasinathan
	 * @throws InterruptedException
	 * @description: To verify that 'Total Audio Docs Completed' count should be
	 *               display correct in 'Review Progress Report'/'Assignment
	 *               Progress Report'. RPMXCON-56540
	 */
	...
	public void validateTotalAudioDocsInARPRandRRPR() throws InterruptedException, ParseException {
		...
		bc.stepInfo(
				"To verify that 'Total Audio Docs Completed' count should be display correct in 'Review Progress Report'/'Assignment Progress Report'");
		// Login as Reviewer Manager
		lp.loginToSightLine(Input.rmu1userName, Input.rmu1password);
		bc.stepInfo("Successfully login as Reviewer Manager'" + Input.rmu1userName + "'");
		assgnmntPg = new AssignmentsPage(driver);
		...
		arpr.generateARPreport(assignmentGrpName, "1LR");
		driver.waitForPageToBeReady();
		String completedDocsInARP = arpr.getColoumnValue(arpr.agnmtColumnNameHeader(), "Total Audio Docs Completed",
				assign1);
		String actualTotalAudioHoursInARP = arpr.getColoumnValue(arpr.agnmtColumnNameHeader(),
				"Total Audio Hours Completed", assign1);
		...
		bc.passedStep(
				"Total audio hours completed are " + actualTotalAudioHoursInARP + " displayed in report as expected");
		this.driver.getWebDriver().get(Input.url + "Report/ReportsLanding");
		rrpr.navigateToReviewerReviewProgressReport();
		rrpr.generateRRPreport(assignmentGrpName, Input.rev1FullName);
		driver.waitForPageToBeReady();
		String completedDocsInRRP = rrpr.getColoumnValue(rrpr.reviewerColumnNameHeader(), "Total Audio Docs Completed",
				assign1);
		String actualTotalAudioHoursInRRP = rrpr.getColoumnValue(rrpr.reviewerColumnNameHeader(),
				"Total Audio Hours Completed", assign1);
		...
		bc.passedStep(
				"Total audio hours completed are " + actualTotalAudioHoursInRRP + " displayed in report as expected");
	 ...
	 * @author Iyappan.Kasinathan
	 * @throws InterruptedException
	 * @description: To Verify RMU can able to generate 'Review Progress Assignment
	 *               Report' using following Options \"Assignment\",Assignment
	 *               Level,Assigment Group. RPMXCON-48701
	 */
	...
	public void verifyRMUuserAbleToGenerateReport() throws InterruptedException, ParseException {
		...
		bc.stepInfo(
				"To Verify RMU can able to generate 'Review Progress Assignment Report' using following Options \"Assignment\",Assignment Level,Assigment Group.");
		// Login as Reviewer Manager
		lp.loginToSightLine(Input.rmu1userName, Input.rmu1password);
		bc.stepInfo("Successfully login as Reviewer Manager'" + Input.rmu1userName + "'");
		assgnmntPg = new AssignmentsPage(driver);
		...
		bc.passedStep(
				"Without selecting assignment group and assignment level error message getting successfully as expected");
		arpr.generateARPreport(assignmentGrpName, "1LR");
		assgnmntPg.deleteAssignmentFromSingleAssgnGrp(assignmentGrpName, assignmentName);
		assgnmntPg.DeleteAssgnGroup(assignmentGrpName);
		lp.logout();
	 ...
	 * @author Iyappan.Kasinathan
	 * @throws InterruptedException
	 * @description: To verify that in reviewer progress report,\"My Batch Docs
	 *               Completed By Me\" column should contain the number of documents
	 *               that were distributed and completed by that reviewer.
	 *               RPMXCON-48769
	 */
	...
	public void verifyMyBatchDocsCompletedByMeInRRP() throws InterruptedException, ParseException {
		...
		bc.stepInfo(
				"To verify that in reviewer progress report,\"My Batch Docs Completed By Me\" column should contain the number of documents that were distributed and completed by that reviewer.");
		// Login as Reviewer Manager
		lp.loginToSightLine(Input.rmu1userName, Input.rmu1password);
		bc.stepInfo("Successfully login as Reviewer Manager'" + Input.rmu1userName + "'");
		assgnmntPg = new AssignmentsPage(driver);
		...
		rrpr.generateRRPreport(assignmentGrpName, Input.rev1FullName);
		driver.waitForPageToBeReady();
		String batchDocsCompletedInRRP = rrpr.getColoumnValue(rrpr.reviewerColumnNameHeader(),
				"My Batch Docs Completed by Me", assignmentName);
	 ...
	 * @author Iyappan.Kasinathan
	 * @throws InterruptedException
	 * @description: Validate data on Assignment Review Progress report when Domain
	 *               and Project Admin users are associated to Assignments of a
	 *               project
	 */
	...
	public void verifyARPRwithDaAndPaUsers() throws InterruptedException, ParseException {
		...
		bc.stepInfo(
				"Validate data on Assignment Review Progress report when Domain and Project Admin users are associated to Assignments of a project");
		// Login as Reviewer Manager
		lp.loginToSightLine(Input.rmu1userName, Input.rmu1password);
		bc.stepInfo("Successfully login as Reviewer Manager'" + Input.rmu1userName + "'");
		assgnmntPg = new AssignmentsPage(driver);
		...
		softAssertion.assertAll();
		bc.passedStep(
				"Validated successfully assignment review progress report when Domain and Project Admin users are associated to assignments of a project");
		assgnmntPg.deleteAssignmentFromSingleAssgnGrp(assignmentGrpName, assignmentName);
		assgnmntPg.DeleteAssgnGroup(assignmentGrpName);
		lp.logout();
	}
	 ...
	 * @author Iyappan.Kasinathan
	 * @throws InterruptedException
	 * @description: To verify that 'Total Audio Distributed Hours' count should be
	 *               display correct in 'Review Progress Report'
	 */
	...
	public void verifyTotalAudioDistributedHoursInRRPR() throws InterruptedException, ParseException {
		...
		bc.stepInfo(
				"To verify that 'Total Audio Distributed Hours' count should be display correct in 'Review Progress Report'");
		// Login as Reviewer Manager
		lp.loginToSightLine(Input.rmu1userName, Input.rmu1password);
		bc.stepInfo("Successfully login as Reviewer Manager'" + Input.rmu1userName + "'");
		assgnmntPg = new AssignmentsPage(driver);
		...
		driver.waitForPageToBeReady();
		String actualTotalAudioHoursInRRP = rrpr.getColoumnValue(rrpr.reviewerColumnNameHeader(),
				"Total Audio Hours Distributed", assign1);
		softAssertion.assertEquals(actualTotalAudioHoursInRRP, expectedTotalTimeDuration);
		bc.passedStep(
				"Total audio hours distributed are " + actualTotalAudioHoursInRRP + " displayed in report as expected");
		assgnmntPg.deleteAssignmentFromSingleAssgnGrp(assignmentGrpName, assign1);
		assgnmntPg.DeleteAssgnGroup(assignmentGrpName);
		softAssertion.assertAll();
		// logout
